...
%
% TO NOTICE:
% modified FGM.m for TG_SI_snapshot_ex1.m
% S.Tan, IOCAS, 2019/09/18

function [v,vz,vzz,b,n2,Ri,zz,I_FGM,GR_FGM,CR_FGM,CI_FGM,W_FGM,K_FGM,CL_FGM,II0,GR0,CR0,CI0,W0]=FGM_snapshot_ex1(data,dz,D1,D2,HOWTO,BOT,K_init,L_init,nu,kap,Av,Ah,Kv,Kh,iBC1,iBCN,k_thred,bs,tool)

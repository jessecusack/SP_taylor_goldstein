...
% FG method, automatically impermeable, frictionless, constant-buoyancy boundaries, no background viscosity, diffusivity, 2nd scan
...
LON = mlon; LAT = mlat;
eval(strcat('save TG_SI_',  filename(filenum).name(1:end-4), '_ex2.mat II GR CR CI CL KFGM K L zw W V Vz Vzz B N2 Ri LON LAT botz'))
end